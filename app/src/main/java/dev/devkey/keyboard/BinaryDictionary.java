...
public class BinaryDictionary extends Dictionary {
    ...
    static {
        try {
            ...
            Log.i("PCKeyboard", "loaded jni_pckeyboard via JNI bridge");
    ...
    private long openNative(ByteBuffer bb, int typedLetterMultiplier,
            int fullWordMultiplier, int dictSize) {
        return org.pocketworkstation.pckeyboard.BinaryDictionary.openNative(
                bb, typedLetterMultiplier, fullWordMultiplier, dictSize);
    }
    private void closeNative(long dict) {
        org.pocketworkstation.pckeyboard.BinaryDictionary.closeNative(dict);
    }
    private boolean isValidWordNative(long nativeData, char[] word, int wordLength) {
        return org.pocketworkstation.pckeyboard.BinaryDictionary.isValidWordNative(
                nativeData, word, wordLength);
    }
    private int getSuggestionsNative(long dict, int[] inputCodes, int codesSize,
        ...
        return org.pocketworkstation.pckeyboard.BinaryDictionary.getSuggestionsNative(
    ...
    private int getBigramsNative(long dict, char[] prevWord, int prevWordLength,
            int[] inputCodes, int inputCodesLength, char[] outputChars, int[] frequencies,
            int maxWordLength, int maxBigrams, int maxAlternatives) {
        return org.pocketworkstation.pckeyboard.BinaryDictionary.getBigramsNative(
