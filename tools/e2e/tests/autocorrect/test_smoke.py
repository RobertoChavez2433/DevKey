"""
Autocorrect smoke tests (subdirectory format).

Migrated from tools/e2e/tests/test_autocorrect.py -- same test logic,
relocated into the autocorrect/ test package for Phase 6 organisation.
...
def test_autocorrect_off_no_correction():
    ...
    # Wait for the space event to confirm input was processed
    driver.wait_for(
        category="DevKey/TXT",
