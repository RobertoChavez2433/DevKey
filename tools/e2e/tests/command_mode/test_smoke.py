"""
Command mode smoke tests — migrated from test_command_mode.py.

Covers the basic command mode toggle lifecycle:
  1. Toggle command mode via broadcast
  2. Verify command_mode_manual_enabled event with structural-only payload
  3. Toggle off and verify IME survives
